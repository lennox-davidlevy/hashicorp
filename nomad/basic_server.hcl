...
advertise {
  ...
  http = "192.168.252.108" # must be reachable by Nomad CLI clients
  rpc  = "192.168.252.108" # must be reachable by Nomad client nodes
  serf = "192.168.252.108" # must be reachable by Nomad server nodes
}
